...
#define kf_log_detail(KFLOGMACROTEXT) {std::stringstream tempstream; tempstream<<__FILE__<<"("<<kf::u32(__LINE__)<<") : "<<KFLOGMACROTEXT<<std::endl; kf::Log::getDefault().log(0, "General", tempstream);}
#define kf_log_detail2(KFLOGMACROLEVEL, KFLOGMACROTEXT) {std::stringstream tempstream; tempstream<<__FILE__<<"("<<kf::u32(__LINE__)<<") : "<<KFLOGMACROTEXT<<std::endl; kf::Log::getDefault().log(KFLOGMACROLEVEL, "General", tempstream);}
#define kf_log_detail3(KFLOGMACROLEVEL, KFLOGMACROSUBSYS, KFLOGMACROTEXT) {std::stringstream tempstream; tempstream<<__FILE__<<"("<<kf::u32(__LINE__)<<") : "<<KFLOGMACROTEXT<<std::endl; kf::Log::getDefault().log(KFLOGMACROLEVEL, KFLOGMACROSUBSYS, tempstream);}
