...
const int Perlin::c_perlin_b=(0x100);
const int Perlin::c_perlin_bm=(0xff);
const int Perlin::c_perlin_n=(0x1000);
const int Perlin::c_perlin_np=(12);
const int Perlin::c_perlin_nm=(0xfff);
